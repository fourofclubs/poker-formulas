...
object mon {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(356); 
  ...
  Monoids.parFoldMap(IndexedSeq(1, 2, 3, 4, 5, 6), Monoids.intMultiplication)(a => a)(es);System.out.println("""res6: java.util.concurrent.Future[Int] = """ + $show(res$6));$skip(50); val res$7 = 
  Monoids.wordCount("lorem ipsum dolor sit amet");System.out.println("""res7: Int = """ + $show(res$7));$skip(42); val res$8 = 
  Monoids.bag(IndexedSeq(0, 0, 1, 0, 10));System.out.println("""res8: Map[Int,Int] = """ + $show(res$8));$skip(15); 
